...
export class ConferenceTransport {
    ...
    _linkDown(linkId) {
        ...
        if (peer === undefined)
            this.stats.skipNoPeer++;
        else if (this._byPeer.has(peer))
    ...
    _sweepIdleOrigins() {
        ...
        for (const [id, o] of this._origins) {
            if (o.gone || o.suspectTimer !== undefined || o.lastHeard > deadline)
                continue;
            if (this._byPeer.has(id))
                continue; // a link of our own is the better witness
