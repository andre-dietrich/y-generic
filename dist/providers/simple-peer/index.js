...
export class SimplePeerTransport {
    ...
    send(data) {
        ...
        for (const peerConn of unsendable)
    ...
    dropUnsendable(peerConn) {
        if (this.peers.get(peerConn.peerId) !== peerConn)
            return;
    ...
    async connectSignaling(url) {
        return new Promise((resolve, reject) => {
            ...
            ws.onclose = () => {
                ...
                if (this._abandonedSockets.delete(ws))
                    return;
